...
def handle_embeddings():
    try:
        ...
        # --- ROBUSTNESS FIX ---
        # The llama.cpp server expects 'input' to be a string or an array of strings.
        # This code ensures that we build a valid payload regardless of
        # whether the incoming 'input' is a single item or a list.
        ...
        response = requests.post(
            serverconfig.LLAMA_CPP_RAW_EMBEDDING_URL,
            json=safe_payload,
            headers=headers,
            timeout=30
        )
        ...
        # Log the specific error from the backend for easier debugging
